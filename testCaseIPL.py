...
class testcode(unittest.TestCase):
    ...
    def test_1st(self):
        ...
        result = IPLcode.NoOfMatchesPlayedPerYear(mockMatchesPath)
        ...
        # Q = [val for val in range(len(x))]
        plt.bar(X + 0.00, data[0], color='b', width=0.25)
        plt.bar(X + 0.2, data[1], color='g', width=0.25)
        plt.show()
    ...
    #     result = IPLcode.NumberOfMatchesWonPerTeamPerYearInIPL(mockMatchesPath)
    #     self.assertEqual(result, test1)
    #     # self.assertEqual(result, test2)
    ...
    #     result = IPLcode.ExtraRunsPerTeamIn2016(mockDelPath, mockMatchesPath)
    #     self.assertEqual(result, test1)
    #     # self.assertEqual(result, test2)
    ...
    #     result = IPLcode.Top10EconomicalBowlerIn2015(mockDelPath,
    #                                                  mockMatchesPath)
    #     self.assertEqual(result, test1)
    #     # self.assertEqual(result, test2)
